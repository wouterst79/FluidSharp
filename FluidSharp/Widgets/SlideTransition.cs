...
namespace FluidSharp.Widgets
{
    public class SlideTransition : AnimatedWidget
    {
        ...
        public SlideTransition(Widget childA, Widget childB, float pctOutA, float pctInB) : base(new FluidSharp.Animations.Animation(DateTime.UtcNow, TimeSpan.FromSeconds(1)), (Widget)null)
        {
